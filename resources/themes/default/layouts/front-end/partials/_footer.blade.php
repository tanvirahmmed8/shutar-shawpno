<div class="__inline-9 rtl">
                        ...
                        <div>
                            <a href="{{route('about-us')}}">
                                <div class="text-center text-primary">
                                    <img class="object-contain svg" width="36" height="36" src="{{theme_asset(path: "public/site-assets/front-end/img/icons/about-us.svg")}}"
                                        alt="{{ translate('About us') }}">
                                </div>
                    ...
                    <div class="footer-slide-item">
                        <div>
                            <a href="{{route('contacts')}}">
                                <div class="text-center text-primary">
                                    <img class="object-contain svg" width="36" height="36" src="{{ theme_asset(path: "public/site-assets/front-end/img/icons/contact-us.svg") }}"
                                        alt="{{ translate('Contact us') }}">
                                </div>
                                <div class="text-center">
                                    <p class="m-0 mt-2">
                    ...
                    <div class="footer-slide-item">
                        <div>
                            <a href="{{route('helpTopic')}}">
                                <div class="text-center text-primary">
                                    <img class="object-contain svg" width="36" height="36" src="{{theme_asset(path: "public/site-assets/front-end/img/icons/faq-icon.svg")}}"
                                        alt="{{ translate('FAQ') }}">
                                </div>
                                <div class="text-center">
                                    <p class="m-0 mt-2">
    ...
    <footer class="page-footer font-small mdb-color rtl footer-modern" role="contentinfo" aria-label="{{ translate('Site footer') }}">
                    ...
                    <div class="col-md-3 footer-web-logo text-center text-md-start ">
                        ...
                        <div class="store-contents d-flex justify-content-center pr-lg-4">
                            @if($web_config['ios']['status'])
                                ...
                                <img width="100" src="{{theme_asset(path: "public/site-assets/front-end/png/apple_app.png")}}"
                            ...
                            @if($web_config['android']['status'])
                                ...
                                <img width="100" src="{{theme_asset(path: "public/site-assets/front-end/png/google_app.png")}}"
                    ...
                    <div class="col-md-9">
                        <div class="row">
                            <div class="col-sm-3 col-6 footer-padding-bottom text-start">
                                <h6 class="text-uppercase mobile-fs-12 font-semi-bold footer-header" id="footer-special-heading">{{ translate('special')}}</h6>
                                <nav aria-labelledby="footer-special-heading">
                                <ul class="widget-list __pb-10px footer-links" role="list">
                            ...
                            <div class="col-sm-4 col-6 footer-padding-bottom text-start">
                                <h6 class="text-uppercase mobile-fs-12 font-semi-bold footer-header" id="footer-account-heading">{{ translate('account_&_shipping_info')}}</h6>
                                ...
                                @if(auth('customer')->check())
                                    <nav aria-labelledby="footer-account-heading"><ul class="widget-list __pb-10px footer-links" role="list">
                                        <li class="widget-list-item">
                                ...
                                <div class="text-nowrap mb-4 position-relative">
                                    <form action="{{ route('subscription') }}" method="post">
                                        ...
                                        <input type="email" name="subscription_email"
                                               ...
                                               placeholder="{{ translate('your_Email_Address')}}" aria-label="{{ translate('your_Email_Address') }}" required>
                                        <button class="subscribe-button btn-modern" type="submit">
                                            {{ translate('subscribe')}}
                                        </button>
                                    </form>
                                </div>
                        ...
                        <div class="row mt-4 {{Session::get('direction') === "rtl" ? ' flex-row-reverse' : ''}}">
                            ...
                            <div class="col-md-5 text-start">
                                ...
                                <div>
                                    <address class="__text-14px d-flex align-items-center mb-0">
                                        <i class="fa fa-map-marker me-2 mt-2 mb-2" aria-hidden="true"></i>
                            ...
                            @foreach ($web_config['social_media'] as $item)
                                <span class="social-media ">
                                    @if ($item->name == "twitter")
                                        <a class="social-btn text-white sb-light sb-{{$item->name}} me-2 mb-2 d-flex justify-content-center align-items-center social-btn-modern"
                                           target="_blank" rel="noopener noreferrer" href="{{$item->link}}" aria-label="{{$item->name}}">
                                    ...
                                    @else
                                        <a class="social-btn text-white sb-light sb-{{$item->name}} me-2 mb-2 social-btn-modern"
                                           target="_blank" rel="noopener noreferrer" href="{{$item->link}}" aria-label="{{$item->name}}">
