...
@section('content')
    <div class="container py-2 py-md-4 p-0 p-md-2 user-profile-container px-5px fashion-user-profile-page">
        <div class="row">
            @include('web-views.partials._profile-aside')
            <section class="col-lg-9 __customer-profile px-0">
                <div class="card fashion-profile-card">
                    <div class="card-body fashion-profile-body">

                        <div class="d-flex align-items-center justify-content-between gap-2 mb-3 fashion-profile-header">
                            <div class="fashion-profile-title-wrapper">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="fashion-profile-icon">
                                ...
                                <h5 class="font-bold m-0 fs-16 fashion-profile-title">{{ translate('profile_Info') }}</h5>
                            </div>
                            <button class="profile-aside-btn btn btn--primary px-2 rounded px-2 py-1 d-lg-none fashion-mobile-menu-btn">
                            ...
                            <div class="text-end d-none d-lg-block">
                                <div class="dropdown fashion-profile-dropdown">
                                    <button class="btn border border-base px-2 py-1 fashion-dropdown-btn" type="button" data-toggle="dropdown">
                                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="fashion-more-icon">
                                            <path d="M12 8C13.1 8 14 7.1 14 6C14 4.9 13.1 4 12 4C10.9 4 10 4.9 10 6C10 7.1 10.9 8 12 8ZM12 10C10.9 10 10 10.9 10 12C10 13.1 10.9 14 12 14C13.1 14 14 13.1 14 12C14 10.9 13.1 10 12 10ZM12 16C10.9 16 10 16.9 10 18C10 19.1 10.9 20 12 20C13.1 20 14 19.1 14 18C14 16.9 13.1 16 12 16Z" fill="currentColor"/>
                                        </svg>
                                    </button>
                                    <div class="dropdown-menu delete-account-dropdown-menu fashion-dropdown-menu">
                                        <a class="dropdown-item call-route-alert fashion-dropdown-item" href="javascript:"
                                           data-route="{{ route('account-delete',[$customerDetail['id']]) }}"
                                           data-message="{{translate('want_to_delete_this_account')}}?">
                                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="fashion-delete-icon">
