@if(isset($product))
    ...
    <div class="fashion-product-card fashion-product-card-vertical card-modern product-card flash_deal_product get-view-by-onclick" data-link="{{ route('product',$product->slug) }}">
        {{-- Discount Badge --}}
        ...
        <button class="btn-modern w-100 fashion-add-to-cart"
