...
@php($billingInputByCustomer=getWebConfig(name: 'billing_input_by_customer'))
    <div class="container py-4 rtl __inline-56 px-0 px-md-3 text-align-direction fashion-shipping-page">
        <div class="row mx-max-md-0">
            <div class="col-md-12 mb-3">
                <div class="fashion-shipping-header">
                    <div class="fashion-shipping-title-wrapper">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="fashion-shipping-icon">
                            <path d="M3 13H1V7C1 5.9 1.9 5 3 5H6V11H4V13M8 5V11H4V5H3C1.9 5 1 5.9 1 7V13H3V15C3 16.1 3.9 17 5 17S7 16.1 7 15V13H8M16 11H10V5H16M18 5V7H20L22 11V13H21V15C21 16.1 20.1 17 19 17S17 16.1 17 15V13H8V15C8 16.1 7.1 17 6 17S4 16.1 4 15V13H2V7C2 5.9 2.9 5 4 5H18Z" fill="currentColor"/>
                        </svg>
                        <h3 class="font-weight-bold text-center text-lg-left fashion-shipping-title">{{translate('checkout')}}</h3>
                    </div>
                </div>
            </div>
            <section class="col-lg-8 px-max-md-0">
                <div class="checkout_details fashion-shipping-details">
                <div class="px-3 px-md-3">
                    ...
                    @if($physical_product_view)
                        ...
                        <div class="px-3 px-md-0">
                            <div class="fashion-shipping-address-header">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="fashion-address-icon">
                                ...
                                <h4 class="pb-2 mt-4 fs-18 text-capitalize fashion-address-title">{{ translate('shipping_address')}}</h4>
                            </div>
                        </div>
