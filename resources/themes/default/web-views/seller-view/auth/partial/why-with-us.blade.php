<section class="section-padding">
    <div class="container">
        <div class="d-flex flex-column gap-2 align-items-center text-center">
            ...
            <img width="395" src="{{!empty($sellWithUs?->image) ? getStorageImages(path:imagePathProcessing(imageData: $sellWithUs?->image, path: 'vendor-registration-setting'),type: 'product') : theme_asset('public/site-assets/front-end/img/media/sell-with-us.png')}}" alt="" class="dark-support">
        </div>
