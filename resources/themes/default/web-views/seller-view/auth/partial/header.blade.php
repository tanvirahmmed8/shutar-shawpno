        ...
        <div class="d-flex justify-content-center">
            <div class="ext-center">
                ...
                <div class="my-4 text-center">
                    <img width="308" src="{{ !empty($vendorRegistrationHeader?->image)  ? getStorageImages(path:imagePathProcessing(imageData: $vendorRegistrationHeader?->image, path: 'vendor-registration-setting'),type: 'product') : theme_asset('public/site-assets/front-end/img/media/seller-registration.png')}}" alt="" class="dark-support">
                </div>
            </div>
        </div>
    </div>
