    ...
    <div class="container">
        ...
        <div class="horizontal-scroll d-flex justify-content-between gap-3 gap-lg-4">
            <div class="d-flex flex-column gap-3 align-items-center text-center">
                <img width="100 " src="{{isset($businessProcessStep[0]) && !empty($businessProcessStep[0]->image) ? getStorageImages(path:imagePathProcessing(imageData: $businessProcessStep[0]->image, path: 'vendor-registration-setting'),type: 'product') : theme_asset('public/site-assets/front-end/img/media/step1.png')}}" alt="" class="dark-support">
            ...
            <div class="middle-step-of-steps d-flex flex-column gap-3 align-items-center text-center">
                <img width="100 " src="{{isset($businessProcessStep[1]) && !empty($businessProcessStep[1]->image) ? getStorageImages(path:imagePathProcessing(imageData: $businessProcessStep[1]->image, path: 'vendor-registration-setting'),type: 'product') : theme_asset('public/site-assets/front-end/img/media/step2.png')}}" alt="" class="dark-support">
            ...
            <div class="d-flex flex-column gap-3 align-items-center text-center">
                <img width="100 " src="{{isset($businessProcessStep[2]) && !empty($businessProcessStep[2]->image) ? getStorageImages(path:imagePathProcessing(imageData: $businessProcessStep[2]->image, path: 'vendor-registration-setting'),type: 'product') : theme_asset('public/site-assets/front-end/img/media/step3.png')}}" alt="" class="dark-support">
