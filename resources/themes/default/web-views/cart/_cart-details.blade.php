<div class="fashion-cart-header">
    <h1 class="fashion-cart-title mt-4 mb-3 text-center text-lg-left mobile-fs-20 fs-18 font-bold">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="me-2">
            <path d="M3 3h2l.4 2M7 13h10l4-8H5.4m1.6 8L5 3H3m4 10v6a1 1 0 001 1h1m0-1a1 1 0 002 0m-3 1a1 1 0 002 0m0-1V13a1 1 0 00-1-1H9a1 1 0 00-1 1v.01" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
...
<div class="fashion-cart-layout row g-3 mx-max-md-0 mb-3">
    <section class="fashion-cart-items col-lg-8 px-max-md-0">
        @if(count($cart)==0)
