...
<div id="sidebarMain" class="d-none">
    <aside
        class="bg-white js-navbar-vertical-aside navbar navbar-vertical-aside navbar-vertical navbar-vertical-fixed navbar-expand-xl navbar-bordered text-start admin-sidebar-modern"
        ...
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-footer-offset pb-0">
                <div class="navbar-vertical-content">
                    <div class="sidebar--search-form pb-3 pt-4 mx-3" role="search">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        @endif
                        @if (Helpers::module_permission_check(config('purchase.module_key', 'purchase_management')))
                            <li class="nav-item">
                                <small class="nav-subtitle text-uppercase">{{ translate('purchase_module') }}</small>
                                <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                            </li>
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/purchase/vendors*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    href="{{ route('admin.purchase.vendors.index') }}"
                                    title="{{ translate('vendors') }}">
                                    <i class="tio-briefcase nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        {{ translate('purchase_vendors') }}
                                    </span>
                                </a>
                            </li>
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/purchase/requisitions*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    href="{{ route('admin.purchase.requisitions.index') }}"
                                    title="{{ translate('purchase_requisitions') }}">
                                    <i class="tio-file-text nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        {{ translate('purchase_requisitions') }}
                                    </span>
                                </a>
                            </li>
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/purchase/orders*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                            ...
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/purchase/grns*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    href="{{ route('admin.purchase.grns.index') }}"
                                    title="{{ translate('goods_receipts') }}">
                                    <i class="tio-receipt-outlined nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        {{ translate('purchase_grns') }}
                                    </span>
                                </a>
                            </li>
                        @endif
                        @php($accountsFinanceKey = config('accounts_finance.module_key', 'accounts_finance'))
                        @if (config('accounts_finance.enabled') && Helpers::module_permission_check($accountsFinanceKey))
                            <li class="nav-item">
                                <small
                                    class="nav-subtitle text-uppercase">{{ translate('accounts_finance_module') }}</small>
                                <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                            </li>
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/accounts-finance*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                    href="javascript:" title="{{ translate('accounts_finance_dashboard') }}">
                                    <i class="tio-wallet nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        {{ translate('accounts_finance_dashboard') }}
                                    </span>
                                </a>
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{ Request::is('admin/accounts-finance*') ? 'block' : 'none' }}">
                                    <li class="nav-item {{ Request::is('admin/accounts-finance') ? 'active' : '' }}">
                                        <a class="nav-link" href="{{ route('admin.accounts-finance.dashboard') }}"
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('admin/accounts-finance/accounts*') ? 'active' : '' }}">
                                        <a class="nav-link"
                                            href="{{ route('admin.accounts-finance.accounts.index') }}"
                                            title="{{ translate('finance_accounts') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{ translate('finance_accounts') }}</span>
                                        </a>
                                    </li>
                                    <li
                                        class="nav-item {{ Request::is('admin/accounts-finance/payment-mappings*') ? 'active' : '' }}">
                                        <a class="nav-link"
                                            href="{{ route('admin.accounts-finance.payment-mappings.edit') }}"
                                            title="{{ translate('payment_method_mappings') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{ translate('payment_method_mappings') }}</span>
                                        </a>
                                    </li>
                                    <li
                                        class="nav-item {{ Request::is('admin/accounts-finance/journals*') ? 'active' : '' }}">
                                        <a class="nav-link"
                                            href="{{ route('admin.accounts-finance.journals.index') }}"
                                            title="{{ translate('finance_journals') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{ translate('finance_journals') }}</span>
                                        </a>
                                    </li>
                                    <li
                                        class="nav-item {{ Request::is('admin/accounts-finance/reconciliations*') ? 'active' : '' }}">
                                        <a class="nav-link"
                                            href="{{ route('admin.accounts-finance.reconciliations.index') }}"
                                            title="{{ translate('reconciliations') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{ translate('reconciliations') }}</span>
                                        </a>
                                    </li>
                                    <li
                                        class="nav-item {{ Request::is('admin/accounts-finance/expenses*') ? 'active' : '' }}">
                                        <a class="nav-link"
                                            href="{{ route('admin.accounts-finance.expenses.index') }}"
                                            title="{{ translate('finance_expenses') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{ translate('finance_expenses') }}</span>
                                        </a>
                                    </li>
                                    <li
                                        class="nav-item {{ Request::is('admin/accounts-finance/transfers*') ? 'active' : '' }}">
                                        <a class="nav-link"
                                            href="{{ route('admin.accounts-finance.transfers.index') }}"
                                            title="{{ translate('account_transfers') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{ translate('account_transfers') }}</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/accounts-finance/reports*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                    href="javascript:" title="{{ translate('finance_reports') }}">
                                    <i class="tio-chart-bar-4 nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        {{ translate('finance_reports') }}
                                    </span>
                                    {{-- <span class="text-truncate">{{ translate('finance_reports') }}</span> --}}
                                </a>
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{ Request::is('admin/accounts-finance/reports*') ? 'block' : 'none' }}">
                                    <li
                                        class="nav-item {{ Request::is('admin/accounts-finance/reports/trial-balance*') ? 'active' : '' }}">
                                        <a class="nav-link"
                                            href="{{ route('admin.accounts-finance.reports.trial-balance') }}"
                                            title="{{ translate('trial_balance') }}">
                                            <span class="tio-circle-outlined nav-indicator-icon"></span>
                                            <span class="text-truncate">{{ translate('trial_balance') }}</span>
                                        </a>
                                    </li>
                                    <li
                                        class="nav-item {{ Request::is('admin/accounts-finance/reports/balance-sheet*') ? 'active' : '' }}">
                                        <a class="nav-link"
                                            href="{{ route('admin.accounts-finance.reports.balance-sheet') }}"
                                            title="{{ translate('balance_sheet') }}">
                                            <span class="tio-circle-outlined nav-indicator-icon"></span>
                                            <span class="text-truncate">{{ translate('balance_sheet') }}</span>
                                        </a>
                                    </li>
                                    <li
                                        class="nav-item {{ Request::is('admin/accounts-finance/reports/income-statement*') ? 'active' : '' }}">
                                        <a class="nav-link"
                                            href="{{ route('admin.accounts-finance.reports.income-statement') }}"
                                            title="{{ translate('income_statement') }}">
                                            <span class="tio-circle-outlined nav-indicator-icon"></span>
                                            <span class="text-truncate">{{ translate('income_statement') }}</span>
                                        </a>
                                    </li>
                                    <li
                                        class="nav-item {{ Request::is('admin/accounts-finance/reports/cash-flow*') ? 'active' : '' }}">
                                        <a class="nav-link"
                                            href="{{ route('admin.accounts-finance.reports.cash-flow') }}"
                                            title="{{ translate('cash_flow') }}">
                                            <span class="tio-circle-outlined nav-indicator-icon"></span>
                                            <span class="text-truncate">{{ translate('cash_flow') }}</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
