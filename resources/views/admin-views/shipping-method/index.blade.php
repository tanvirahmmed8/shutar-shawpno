                ...
                <form action="{{ route('admin.business-settings.shipping-method.update-shipping-responsibility') }}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="status-filter mt-3">
                            <a class="pill {{ $shippingType=='order_wise' ? 'active' : '' }}" href="#order_wise_shipping">{{translate('order_wise_shipping')}}</a>
                            <a class="pill {{ $shippingType=='category_wise' ? 'active' : '' }}" href="#update_category_shipping_cost">{{translate('category_wise_shipping_cost')}}</a>
                            <a class="pill {{ $shippingType=='product_wise' ? 'active' : '' }}" href="#product_wise_note">{{translate('product_wise_shipping_note')}}</a>
                        </div>
        ...
        <div id="order_wise_shipping">
            ...
            <div class="card mt-3">
                ...
                <div class="table-responsive pb-3">
                        <table
                            class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table table-sticky"
                            style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                        <thead class="thead-light thead-50 text-capitalize">
                        <tr>
                            <th>{{translate('SL')}}</th>
