<div class="p-3 px-xl-4 py-sm-5">
    <div class="text-center">
        <img width="160" class="mb-4" id="view-mail-icon" src="{{ $template->image_full_url['path'] ?? dynamicAsset(path: 'public/site-assets/back-end/img/email-template/change-pass.png')}}" alt="">
