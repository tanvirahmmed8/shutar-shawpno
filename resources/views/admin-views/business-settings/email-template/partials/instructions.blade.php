                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide px-3">
                            <div class="d-flex flex-column align-items-center gap-2">
                                <img width="80" class="mb-3"
                                     src="{{dynamicAsset(path: 'public/site-assets/back-end/img/email-template/2.png')}}"
                                     loading="lazy" alt="">
                        ...
                        <div class="swiper-slide px-3">
                            <div class="d-flex flex-column align-items-center gap-2 mb-4">
                                <img width="80" class="mb-3"
                                     src="{{dynamicAsset(path: 'public/site-assets/back-end/img/email-template/3.png')}}"
                                     loading="lazy" alt="">
                        ...
                        <div class="swiper-slide px-3">
                            <div class="d-flex flex-column align-items-center gap-2 mb-4">
                                <img width="80" class="mb-3"
                                     src="{{dynamicAsset(path: 'public/site-assets/back-end/img/email-template/4.png')}}"
                                     loading="lazy" alt="">
                        ...
                        <div class="swiper-slide px-3">
                            <div class="d-flex flex-column align-items-center gap-2 mb-4">
                                <img width="80" class="mb-3"
                                     src="{{dynamicAsset(path: 'public/site-assets/back-end/img/email-template/5.png')}}"
                                     loading="lazy" alt="">
                        ...
                        <div class="swiper-slide px-3">
                            <div class="d-flex flex-column align-items-center gap-2 mb-4">
                                <img width="80" class="mb-3"
                                     src="{{dynamicAsset(path: 'public/site-assets/back-end/img/email-template/6.png')}}"
                                     loading="lazy" alt="">
                        ...
                        <div class="swiper-slide px-3">
                            <div class="d-flex flex-column align-items-center gap-2 mb-4">
                                <img width="80" class="mb-3"
                                     src="{{dynamicAsset(path: 'public/site-assets/back-end/img/email-template/7.png')}}"
                                     loading="lazy" alt="">
                        ...
                        <div class="swiper-slide px-3">
                            <div class="d-flex flex-column align-items-center gap-2 mb-4">
                                <img width="80" class="mb-3"
                                     src="{{dynamicAsset(path: 'public/site-assets/back-end/img/email-template/8.png')}}"
                                     loading="lazy" alt="">
