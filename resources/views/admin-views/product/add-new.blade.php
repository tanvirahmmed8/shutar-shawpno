                            ...
                            <div class="form-group">
                                <div class="d-flex gap-2 mb-2">
                                    ...
                                    <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                        ...
                                        <img src="{{ asset('public/site-assets/back-end/img/info-circle.svg') }}" alt="">
                                    </span>
                                </div>
                                        ...
                                        <div class="custom_upload_input position-relative border-dashed-2">
                                            ...
                                            <div class="img_area_with_preview position-absolute z-index-2 border-0">
                                                <img id="additional_Image_1" class="h-auto aspect-1 bg-white d-none "
                                                     src="{{ dynamicAsset(path: 'public/site-assets/back-end/img/icons/product-upload-icon.svg') }}" alt="">
                                            </div>
                                            <div
                                                class="position-absolute h-100 top-0 w-100 d-flex align-content-center justify-content-center">
                                                <div
                                        ...
                                        <div class="custom_upload_input">
                                            ...
                                            <div class="img_area_with_preview position-absolute z-index-2 d-flex align-items-center justify-content-center">
                                                <img id="pre_meta_image_viewer" class="h-auto bg-white onerror-add-class-d-none pre-meta-image-viewer" alt=""
                                                     src="{{ dynamicAsset(path: 'public/site-assets/back-end/img/icons/product-upload-icon.svg-dummy') }}">
                                            </div>
                                            <div
...
@push('script')
    ...
    <script src="{{ dynamicAsset(path: 'public/site-assets/back-end/js/admin/product-add-colors-img.js') }}"></script>
@endpush
