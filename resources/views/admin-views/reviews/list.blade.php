    ...
    <div class="content container-fluid">
        ...
        <div class="card mt-20">
            ...
            <div class="px-3 pb-2 d-flex flex-wrap gap-2 align-items-center justify-content-between">
                <div class="status-filter" aria-label="Quick review filters">
                    @php($baseReviewUrl = route('admin.reviews.list'))
                    <a href="{{ $baseReviewUrl }}" class="pill">{{ translate('All') }}</a>
                    <a href="{{ $baseReviewUrl }}?status=1" class="pill pill-confirmed">{{ translate('Active') }}</a>
                    <a href="{{ $baseReviewUrl }}?status=0" class="pill pill-canceled">{{ translate('Inactive') }}</a>
                </div>
            </div>
