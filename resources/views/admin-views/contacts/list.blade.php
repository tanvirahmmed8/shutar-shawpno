            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="px-3 pb-2 d-flex flex-wrap gap-2 align-items-center justify-content-between">
                        <div class="status-filter" aria-label="Quick contact filters">
                            @php($baseContactUrl = route('admin.contact.list'))
                            <a href="{{ $baseContactUrl }}" class="pill">{{ translate('All') }}</a>
                            <a href="{{ $baseContactUrl }}?reply_status=replied" class="pill pill-confirmed">{{ translate('Replied') }}</a>
                            <a href="{{ $baseContactUrl }}?reply_status=not_replied" class="pill pill-canceled">{{ translate('Not_Replied') }}</a>
                        </div>
                    </div>
...
@push('script')
    <script src="{{dynamicAsset(path: 'public/site-assets/back-end/js/admin/contact.js')}}"></script>
@endpush
