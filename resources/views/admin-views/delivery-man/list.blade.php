        ...
        <div class="row">
            <div class="col-sm-12 mb-3">
                <div class="card">
                    <div class="px-3 py-4">
                        <div class="d-flex justify-content-between gap-10 flex-wrap align-items-center">
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                <div class="dropdown">
                                    <a type="button" class="btn btn-outline--primary text-nowrap btn-block" href="{{route('admin.delivery-man.export',['searchValue' => request('searchValue')])}}">
                    ...
                    <div class="px-3 pb-2">
                        <div class="status-filter" aria-label="Quick delivery filters">
                            @php($baseDmUrl = route('admin.delivery-man.list'))
                            <a href="{{ $baseDmUrl }}" class="pill">{{ translate('All') }}</a>
                            <a href="{{ $baseDmUrl }}?status=active" class="pill pill-confirmed">{{ translate('Active') }}</a>
                            <a href="{{ $baseDmUrl }}?status=inactive" class="pill pill-canceled">{{ translate('Inactive') }}</a>
                        </div>
                    </div>
                    <div class="table-responsive datatable-custom">
                        <table class="table table-hover table-borderless table-thead-bordered table-align-middle card-table table-sticky {{ Session::get('direction') === 'rtl' ? 'text-right' : 'text-left' }}">
                            ...
                            @foreach($deliveryMens as $key => $deliveryMen)
                                <tr>
                                    ...
                                    <img class="rounded-circle dm-avatar" alt=""
