        ...
        <div class="row mt-20">
            <div class="col-md-12">
                <div class="">
                    ...
                    <div class="px-3 pb-2 d-flex flex-wrap gap-2 align-items-center justify-content-between">
                        <div class="status-filter ticket-badges" aria-label="Quick ticket filters">
                            @php($baseTicketUrl = route('admin.support-ticket.view'))
                            <a href="{{ $baseTicketUrl }}" class="pill">{{ translate('All') }}</a>
                            <a href="{{ $baseTicketUrl }}?status=open" class="pill pill-confirmed">{{ translate('Open') }}</a>
                            <a href="{{ $baseTicketUrl }}?status=close" class="pill pill-canceled">{{ translate('Closed') }}</a>
                            <a href="{{ $baseTicketUrl }}?priority=urgent" class="pill pill-failed">{{ translate('Urgent') }}</a>
                            <a href="{{ $baseTicketUrl }}?priority=high" class="pill pill-processing">{{ translate('High') }}</a>
                            <a href="{{ $baseTicketUrl }}?priority=medium" class="pill">{{ translate('Medium') }}</a>
                            <a href="{{ $baseTicketUrl }}?priority=low" class="pill">{{ translate('Low') }}</a>
                        </div>
                    </div>
