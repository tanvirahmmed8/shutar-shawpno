                        ...
                        <ul id="navbarSettings"
                            ...
                            <li class="nav-item">
                                <a class="nav-link active d-flex align-items-center gap-2 m-0 py-3" href="javascript:" id="general-section">
                                    <div class="min-w-30px">
                                        <img src="{{ dynamicAsset(path: 'public/site-assets/back-end/img/icons/user-config.svg') }}" alt="">
                                    </div>
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2 m-0 py-3" href="javascript:" id="password-section">
                                    <div class="min-w-30px">
                                        <img src="{{ dynamicAsset(path: 'public/site-assets/back-end/img/icons/password-lock-light.svg') }}" alt="">
                                    </div>
