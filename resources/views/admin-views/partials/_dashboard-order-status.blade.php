<div class="col-sm-6 col-lg-3">
    <a class="business-analytics card" href="{{route('admin.orders.list',['all'])}}">
        ...
        <img src="{{dynamicAsset(path: 'public/site-assets/back-end/img/all-orders.png')}}" width="30" height="30" class="business-analytics__img" alt="">
    </a>
</div>
<div class="col-sm-6 col-lg-3">
    <a class="business-analytics get-view-by-onclick card" href="{{route('admin.vendors.vendor-list')}}">
        ...
        <img src="{{dynamicAsset(path: 'public/site-assets/back-end/img/total-stores.png')}}" class="business-analytics__img" alt="">
    </a>
</div>
<div class="col-sm-6 col-lg-3">
    <a class="business-analytics card">
        ...
        <img src="{{dynamicAsset(path: 'public/site-assets/back-end/img/total-product.png')}}" class="business-analytics__img" alt="">
    </a>
</div>
<div class="col-sm-6 col-lg-3">
    <a class="business-analytics card" href="{{route('admin.customer.list')}}">
        ...
        <img src="{{dynamicAsset(path: 'public/site-assets/back-end/img/total-customer.png')}}" class="business-analytics__img" alt="">
    </a>
</div>
...
<div class="col-sm-6 col-lg-3">
    <a class="order-stats order-stats_pending" href="{{route('admin.orders.list',['pending'])}}">
        <div class="order-stats__content">
            <img width="20" src="{{dynamicAsset(path: '/public/site-assets/back-end/img/pending.png')}}" alt="">
...
<div class="col-sm-6 col-lg-3">
    <a class="order-stats order-stats_confirmed" href="{{route('admin.orders.list',['confirmed'])}}">
        <div class="order-stats__content">
            <img width="20" src="{{dynamicAsset(path: 'public/site-assets/back-end/img/confirmed.png')}}" alt="">
...
<div class="col-sm-6 col-lg-3">
    <a class="order-stats order-stats_packaging" href="{{route('admin.orders.list',['processing'])}}">
        <div class="order-stats__content">
            <img width="20" src="{{dynamicAsset(path: 'public/site-assets/back-end/img/packaging.png')}}" alt="">
...
<div class="col-sm-6 col-lg-3">
    <a class="order-stats order-stats_out-for-delivery" href="{{route('admin.orders.list',['out_for_delivery'])}}">
        <div class="order-stats__content">
            <img width="20" src="{{dynamicAsset(path: 'public/site-assets/back-end/img/out-of-delivery.png')}}" alt="">
...
<div class="col-sm-6 col-lg-3">
    <div class="order-stats order-stats_delivered cursor-pointer get-view-by-onclick" data-link="{{route('admin.orders.list',['delivered'])}}">
        <div class="order-stats__content">
            <img width="20" src="{{dynamicAsset(path: 'public/site-assets/back-end/img/delivered.png')}}" alt="">
...
<div class="col-sm-6 col-lg-3">
    <div class="order-stats order-stats_canceled cursor-pointer get-view-by-onclick" data-link="{{route('admin.orders.list',['canceled'])}}">
        <div class="order-stats__content">
            <img width="20" src="{{dynamicAsset(path: 'public/site-assets/back-end/img/canceled.png')}}" alt="">
...
<div class="col-sm-6 col-lg-3">
    <div class="order-stats order-stats_returned cursor-pointer get-view-by-onclick" data-link="{{route('admin.orders.list',['returned'])}}">
        <div class="order-stats__content">
            <img width="20" src="{{dynamicAsset(path: 'public/site-assets/back-end/img/returned.png')}}" alt="">
...
<div class="col-sm-6 col-lg-3">
    <div class="order-stats order-stats_failed cursor-pointer get-view-by-onclick" data-link="{{route('admin.orders.list',['failed'])}}">
        <div class="order-stats__content">
            <img width="20" src="{{dynamicAsset(path: 'public/site-assets/back-end/img/failed-to-deliver.png')}}" alt="">
