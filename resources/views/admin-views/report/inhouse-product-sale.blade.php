    ...
    <div class="content container-fluid">
        <div class="mb-3">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                <img width="20" src="{{dynamicAsset(path: 'public/site-assets/back-end/img/inhouse_sale.png')}}" alt="">
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="table-responsive">
                        <table
                            class="table table-hover table-borderless table-thead-bordered table-align-middle card-table w-100 table-sticky">
