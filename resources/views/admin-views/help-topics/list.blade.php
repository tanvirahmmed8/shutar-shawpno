                ...
                <div class="card">
                    ...
                    <div class="card-body px-0">
                        <div class="px-3 pb-2 d-flex flex-wrap gap-2 align-items-center justify-content-between">
                            <div class="status-filter" aria-label="Quick FAQ filters">
                                @php($baseFaqUrl = route('admin.helpTopic.list'))
                                <a href="{{ $baseFaqUrl }}" class="pill">{{ translate('All') }}</a>
                                <a href="{{ $baseFaqUrl }}?status=1" class="pill pill-confirmed">{{ translate('Active') }}</a>
                                <a href="{{ $baseFaqUrl }}?status=0" class="pill pill-canceled">{{ translate('Inactive') }}</a>
                            </div>
                        </div>
                        <div class="table-responsive">
                            <table
                                class="table table-hover table-borderless table-thead-bordered table-align-middle card-table w-100 text-start table-sticky"
                                id="dataTable">
