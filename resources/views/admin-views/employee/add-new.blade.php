    ...
    <div class="content container-fluid">
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
            <div>
                ...
                <p class="text-muted mb-0">{{translate('capture_core_employee_details_and_assign_a_role')}}</p>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                        ...
                        <div class="card-header border-0 pb-0">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted mb-0">{{translate('basic_profile_details_identification_and_role')}}</p>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="row g-4">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <div class="border rounded d-flex flex-column align-items-center justify-content-center p-4 mb-3">
                                            <img class="upload-img-view" id="viewer"
                                                 src="{{dynamicAsset(path: 'public/site-assets/back-end/img/400x400/img2.jpg')}}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <p class="text-muted small mb-2">{{translate('upload_supporting_identity_documents_up_to_5_images')}}</p>
                                        <div class="row select-multiple-image g-3"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-header border-0 pb-0">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted mb-0">{{translate('credentials_are_required_for_admin_panel_access')}}</p>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
