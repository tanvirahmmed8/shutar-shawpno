                        ...
                        <ul class="dm-info p-0 m-0">
                            ...
                            <li class="align-items-center">
                                <span class="left">{{translate('refund_status')}}</span> <span>:</span> <span class="right">
                                    <span class="status-pill {{ 'status-' . $refund['status'] }}">{{translate($refund['status'])}}</span>
                                </span>
                            </li>
                            <li class="align-items-center">
                ...
                <div class="card refund-details-card--2">
                    <div class="card-body ">
                        ...
                        <div class="table-responsive datatable-custom">
                            <table
                                class="table table-hover text-center table-borderless table-thead-bordered table-nowrap table-align-middle card-table table-sticky">
                                ...
                                @foreach ($refund->refundStatus as $key=>$status)
                                    <tr>
                                        ...
                                        <td class="text-capitalize">
                                            <span class="status-pill {{ 'status-' . $status->status }}">{{translate($status->status)}}</span>
                                        </td>
                                        <td class="text-break">
