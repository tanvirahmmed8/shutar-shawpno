...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="card">
            ...
            <div class="px-3 pb-2">
                <div class="status-filter" aria-label="Quick customer filters">
                    @php($baseCustomerUrl = route('admin.customer.list'))
                    <a href="{{ $baseCustomerUrl }}" class="pill">{{ translate('All') }}</a>
                    <a href="{{ $baseCustomerUrl }}?is_active=1" class="pill pill-confirmed">{{ translate('Active') }}</a>
                    <a href="{{ $baseCustomerUrl }}?is_active=0" class="pill pill-canceled">{{ translate('Inactive') }}</a>
                </div>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                             ...
                             <img src="{{getStorageImages(path:$customer->image_full_url,type:'backend-profile')}}"
                                 class="customer-avatar" alt="" width="40" height="40">
