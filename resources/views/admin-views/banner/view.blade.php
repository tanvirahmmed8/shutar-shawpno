        ...
        <div class="row" id="banner-table">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="px-3 pb-2">
                        <div class="status-filter" aria-label="Quick banner filters">
                            @php($baseBannerUrl = route('admin.banner.list'))
                            <a href="{{ $baseBannerUrl }}" class="pill">{{ translate('All') }}</a>
                            <a href="{{ $baseBannerUrl }}?published=1" class="pill pill-confirmed">{{ translate('Published') }}</a>
                            <a href="{{ $baseBannerUrl }}?published=0" class="pill pill-canceled">{{ translate('Unpublished') }}</a>
                        </div>
                    </div>
