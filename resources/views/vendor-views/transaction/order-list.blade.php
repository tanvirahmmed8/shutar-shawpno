    ...
    <div class="content container-fluid ">
        ...
        <div class="store-report-content mb-2">
            <div class="left-content">
                ...
                <div class="left-content-card">
                    <img src="{{dynamicAsset(path: 'public/site-assets/back-end/img/inactive-product.svg')}}" alt="">
                    <div class="info">
                ...
                <div class="left-content-card">
                    <img src="{{dynamicAsset(path: 'public/site-assets/back-end/img/pending_products.svg')}}" alt="">
                    <div class="info">
...
@push('script')
    ...
    <script src="{{ dynamicAsset(path: 'public/site-assets/back-end/js/vendor/transaction-report.js') }}"></script>
@endpush
