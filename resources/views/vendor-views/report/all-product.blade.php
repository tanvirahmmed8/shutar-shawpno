    ...
    <div class="content container-fluid">
        <div class="mb-3">
            <h2 class="h1 mb-0 text-capitalize d-flex gap-2 align-items-center">
                <img width="20" src="{{asset('public/site-assets/back-end/img/seller_sale.png')}}" alt="">
        ...
        <div class="store-report-content mb-2">
            <div class="left-content">
                <div class="left-content-card">
                    <img src="{{dynamicAsset(path: '/public/site-assets/back-end/img/packaging.svg')}}" alt="">
                    <div class="info">
                ...
                <div class="left-content-card">
                    <img src="{{dynamicAsset(path: 'public/site-assets/back-end/img/bag.svg')}}" alt="">
                    <div class="info">
                        <h4 class="subtitle">
                            {{ $total_product_sale }}
                        </h4>
                ...
                <div class="left-content-card">
                    <img src="{{dynamicAsset(path: 'public/site-assets/back-end/img/discount.svg')}}" alt="">
                    <div class="info">
                        <h4 class="subtitle">
...
@push('script')
    ...
    <script src="{{ dynamicAsset(path: 'public/site-assets/back-end/js/vendor/product-report.js') }}"></script>
@endpush
