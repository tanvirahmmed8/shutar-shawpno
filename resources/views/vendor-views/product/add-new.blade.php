                                        ...
                                        <div class="custom_upload_input position-relative border-dashed-2 aspect-1">
                                            ...
                                            <div class="img_area_with_preview position-absolute z-index-2 border-0">
                                                <img id="additional_Image_1" class="h-auto aspect-1 bg-white d-none "
                                                     src="{{ dynamicAsset(path: 'public/site-assets/back-end/img/icons/product-upload-icon.svg-dummy') }}" alt="">
                                            </div>
                                            <div
                                                class="position-absolute h-100 top-0 w-100 d-flex align-content-center justify-content-center">
                                                <div
...
@push('script')
    ...
    <script src="{{ dynamicAsset(path: 'public/site-assets/back-end/js/vendor/product-add-colors-img.js') }}"></script>
@endpush
