...
@push('script')
{{--    <script src="{{ dynamicAsset(path: 'public/site-assets/back-end/js/vendor/deal.js') }}"></script>--}}
    <script src="{{ dynamicAsset(path: 'public/site-assets/back-end/js/vendor/clearance-sale.js') }}"></script>
