...
return [
	...
	"Add_Domain_(For_ex:_demo.tanvirsoft.com)" => "Add Domain (For ex: demo.tanvirsoft.com)",
	...
	"now_you_can_login" => "Now you can login",
	"now_you_can_login_your_account_is_ready_to_use" => "Now you can login your account is ready to use",
	"now_you_will_be_successfully_able_to_use_the_addons_for_your_TanvirSoft_website" => "Now you will be successfully able to use the addons for your TanvirSoft website",
	...
	"purchase_permissions" => "Purchase permissions",
	"purchase_permission_hint" => "Toggle granular access for the purchase workspace",
	"purchase_workspace_access" => "Purchase workspace access",
	"purchase_requisition_access" => "Requisition access",
	"purchase_order_access" => "Purchase order access",
	"purchase_invoice_access" => "Purchase invoice access",
	"purchase_code" => "Purchase code",
	"purchase_price" => "purchase price",
	"purchase_orders" => "Purchase orders",
	"add_purchase_order" => "Add purchase order",
	"search_by_code_name_email" => "Search by code or vendor name",
	"purchase_order_workspace_intro" => "Manage draft, approved, and sent purchase orders from one workspace.",
	"purchase_order_action_placeholder" => "Purchase order actions will be available once the workflow is implemented.",
	"purchase_order_conversion_placeholder" => "Conversion from requisition is coming soon.",
	"purchase_order_send_placeholder" => "Vendor communication workflow is coming soon.",
	"purchase_order_empty_state" => "No purchase orders found yet.",
	"purchase_order_placeholder_details" => "Detailed purchase order view coming soon.",
	"purchase_order_code" => "PO code",
	"purchase_order_summary" => "Purchase order summary",
	"purchase_order_requires_items" => "Add at least one line item to continue.",
	"purchase_requisition_not_ready_for_conversion" => "Only approved requisitions can be converted to purchase orders.",
	"purchase_order_vendor_required" => "Select a vendor before creating the purchase order.",
	"purchase_order_status_invalid_for_action" => "The purchase order status does not allow this action.",
	"purchase_order_vendor_email_required" => "Provide a recipient email before sending the purchase order.",
	"purchase_order_email_subject" => "Purchase Order :code",
	"purchase_order_not_editable" => "Only draft purchase orders can be edited.",
	"purchase_order_delete_not_allowed" => "Only draft or rejected purchase orders can be deleted.",
	"purchase_order_deleted" => "Purchase order deleted successfully.",
	"purchase_order_created_from_requisition" => "Purchase order created from requisition.",
	"purchase_order_send_queued" => "Purchase order send request queued.",
	"purchase_order_approved" => "Purchase order approved.",
	"purchase_order_rejected" => "Purchase order rejected.",
	"purchase_order_acknowledged" => "Purchase order marked as acknowledged.",
	"purchase_order_closed" => "Purchase order closed.",
	"purchase_order_saved_draft" => "Purchase order saved as draft.",
	"purchase_order_submitted_for_approval" => "Purchase order submitted for approval.",
	"date_from" => "Date from",
	"date_to" => "Date to",
	...
	"purchase_order_no_communications" => "No communications have been logged yet.",
	"activity_timeline" => "Activity timeline",
	"activity_log_empty_state" => "No events recorded for this purchase order.",
	...
	"mark_acknowledged" => "Mark as acknowledged",
	"close_purchase_order" => "Close purchase order",
	"mark_closed" => "Mark as closed",
	"pending_assignment" => "Pending assignment",
	"save_draft" => "Save draft",
	"submit_for_approval" => "Submit for approval",
	"purchase_grn_requires_items" => "Add at least one line before saving the goods receipt.",
	"purchase_grn_status_invalid_for_action" => "The goods receipt status does not allow this action.",
	"purchase_grn_item_invalid_order_line" => "One or more receipt lines reference an invalid purchase order item.",
	"purchase_grn_item_requires_received_qty" => "Provide received quantity for each receipt line.",
	"purchase_grn_item_invalid_split" => "Accepted and rejected quantities must add up to the received quantity.",
	"purchase_grn_item_exceeds_outstanding" => "Received quantity exceeds the outstanding purchase order quantity.",
	"purchase_grn_not_editable" => "Only draft goods receipts can be edited.",
	"purchase_invoice_requires_items" => "Add at least one invoice line before saving.",
	"purchase_invoice_number_required" => "Invoice number is required.",
	"purchase_invoice_item_invalid_order_line" => "One or more invoice lines reference an invalid purchase order item.",
	"purchase_invoice_item_invalid_grn_line" => "Invoice line does not belong to the selected goods receipt.",
	"purchase_invoice_item_invalid_quantity" => "Invoice line quantities must be greater than zero.",
	"purchase_invoice_item_invalid_price" => "Invoice line unit price must be greater than zero.",
	"purchase_invoice_invalid_grn" => "Selected goods receipt is not associated with this purchase order.",
	"purchase_invoice_not_editable" => "Only draft invoices can be edited.",
	"purchase_invoice_status_invalid_for_action" => "The invoice status does not allow this action.",
	"purchase_invoice_match_required" => "Invoice must be matched before it can be approved.",
	"purchase_grn_return_requires_items" => "Add at least one rejected line before submitting the return.",
	"purchase_grn_return_only_from_approved" => "Returns can only be initiated from approved goods receipts.",
	"purchase_grn_return_invalid_item" => "One or more return lines reference an invalid receipt item.",
	"purchase_grn_return_qty_invalid" => "Provide a positive return quantity for each line.",
	"purchase_grn_return_qty_exceeds_rejected" => "Return quantity exceeds the available rejected quantity.",
	"purchase_grn_return_status_invalid" => "Action not allowed for the current return status.",
	"purchase_grn_return_created" => "Return to vendor record created.",
	"purchase_grn_return_marked_shipped" => "Return marked as shipped.",
	"purchase_grn_return_closed" => "Return case closed.",
	"acknowledged" => "Acknowledged",
	"purchase_vendor_access" => "Vendor access",
	"purchase_approval_access" => "Approval access",
	"purchase_grn_access" => "GRN access",
	"purchase_reports_access" => "Purchase reports access",
	"purchase_vendor_created_successfully" => "Vendor created successfully",
	"purchase_requisitions" => "Purchase requisitions",
	"requisition_workspace_intro" => "Track requisitions from draft to approval and conversion.",
	"requester" => "Requester",
	...
	"select_approval_route" => "Select approval route",
	"line_items" => "Line items",
	"product_sku_optional" => "Product ID (optional)",
	"add_line_item" => "Add line item",
	"remove_line_item" => "Remove line item",
	"line_total" => "Line total",
	"grand_total" => "Grand total",
	"requisition_saved_draft" => "Requisition saved as draft",
	...
	"requisition_status_invalid_for_action" => "Action not allowed for the current requisition status",
	"requisition_submitted_for_approval" => "Requisition submitted for approval",
	...
	"no_requisition_found" => "No requisition found",
	"requisition_details" => "Requisition details",
	"rejected_reason" => "Rejected reason",
	"requisition_delete_confirmation" => "Delete this requisition?",
	"approval_comments" => "Approval comments",
	"approval_actions" => "Approval actions",
	"pending_approval" => "Pending approval",
	"converted" => "Converted",
	"purchase_vendor_updated_successfully" => "Vendor updated successfully",
	"purchase_vendor_deleted_successfully" => "Vendor deleted successfully",
	...
	"lot_allocations" => "Lot allocations",
	...
	"they_register_TanvirSoft_with_special_offer" => "They register TanvirSoft with special offer",
	...
	"to_view_your_order_sign_into_yourTanvirSoft" => "To view your order sign into yourTanvirSoft",
	"to_wallet" => "To wallet",
	"today" => "Today",
	...
	"N:B you_can_upload_only_TanvirSoft’s_theme_templates" => "N:B you can upload only TanvirSoft’s theme templates",
	...
	"discover_fresh_styles_and_best_deals_today" => "Discover fresh styles and best deals today",
	"Featured promotion" => "Featured promotion",
	...
	"manage_status_and_permissions_from_a_single_table" => "Manage status and permissions from a single table",
	"select_modules" => "Select modules",
	"no_employee_found" => "No employee found",
	"quickly_filter_search_or_export_employee_records" => "Quickly filter search or export employee records",
	...
	"no_activity_for_selected_filters" => "No activity for selected filters",
	"finance_reports" => "Finance reports",
	"profit" => "Profit",
	"net_cash_effect" => "Net cash effect",
	"control_where_app_store_badges_show_up_and_keep_links_fresh" => "Control where app store badges show up and keep links fresh",
	"currency_behavior_and_listing_density_live_here_update_carefully" => "Currency behavior and listing density live here update carefully",
	"Unpublished" => "Unpublished",
	"filters" => "Filters",
	"expenses" => "Expenses",
	"balance_type" => "Balance type",
	"no_reconciliations_found" => "No reconciliations found",
	"submitted" => "Submitted",
	...
	"return_reference_optional" => "Return reference optional",
	"mark_grn_returned" => "Mark grn returned",
	"rejection_reason" => "Rejection reason",
	"reject_goods_receipt" => "Reject goods receipt",
	"keep_primary_contact_details_current_to_power_notifications_and_invoices" => "Keep primary contact details current to power notifications and invoices",
	"toggle_anytime_to_pause_customer-facing_surfaces_with_confidence" => "Toggle anytime to pause customer-facing surfaces with confidence",
	"keep_users_informed_about_planned_downtime_and_resume_services_confidently" => "Keep users informed about planned downtime and resume services confidently",
